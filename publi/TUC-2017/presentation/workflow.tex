...
\begin{frame}{Demo on Mono view}
  \centering
  \animategraphics[controls,buttonsize=0.85em,height=7cm]{7}{animation/mono_demo-}{0}{430} %{430}
\end{frame}
...
\begin{frame}{Demo on Multi view}
  \centering
  \animategraphics[controls,buttonsize=0.85em,height=7cm]{10}{animation/multi_demo-}{0}{205} %{205}
\end{frame}
